...
class CreateVolleyMatch extends StatefulWidget {
  const CreateVolleyMatch({Key? key}) : super(key: key);

  @override
  State<CreateVolleyMatch> createState() => _CreateVolleyMatchState();
}

class _CreateVolleyMatchState extends State<CreateVolleyMatch> {
                  ...
                  child: Column(children: <Widget>[
                    ...
                    signInSignUpButton("Créer", context, false, () {
                      if (_equipeTextController.value.text !=
                        ...
                        FirebaseFirestore.instance.collection('Volley').add({
