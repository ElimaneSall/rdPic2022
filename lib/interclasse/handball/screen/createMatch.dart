...
class CreateHandballMatch extends StatefulWidget {
  CreateHandballMatch({Key? key}) : super(key: key);

  @override
  State<CreateHandballMatch> createState() => _CreateHandballMatchState();
}

class _CreateHandballMatchState extends State<CreateHandballMatch> {
                  ...
                  child: Column(children: <Widget>[
                    ...
                    signInSignUpButton("Créer", context, false, () {
                      if (_equipeTextController.value.text !=
                        ...
                        FirebaseFirestore.instance.collection('Handball').add({
