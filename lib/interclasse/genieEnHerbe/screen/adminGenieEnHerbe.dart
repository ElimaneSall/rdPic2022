...
class AdminGenieEnHerbe extends StatefulWidget {
  const AdminGenieEnHerbe({Key? key}) : super(key: key);

  @override
  State<AdminGenieEnHerbe> createState() => _AdminGenieEnHerbeState();
}
    ...
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton(
        ...
        onPressed: () {
          Navigator.push(
            context,
            MaterialPageRoute(builder: (context) => CreateGenieEnHerbeMatch()),
          );
        },
      ),
